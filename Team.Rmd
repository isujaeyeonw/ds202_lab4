...
## jay's response: i don't think we do. Purdy does not have any defensive stats, so comparing hiis defense
## performance to the teams would not give any insights. 
...
By calculating the averages for all of Purdy's offensive player stats, then finding the average for the offensive stats for the rest of the team (removing Purdy's contribution), we can compare Purdy's personal average and the average of the entire team for offensive statistics.

Purdy has a lot of passing yards because he is the Quaterback. He throws the ball a lot. 
